  ...
  // Google Apps Script server-side files
  {
    ...
    languageOptions: {
      ...
      globals: {
        ...
        extractUserDataFromBatch: 'readonly',
        filterSchedulesByDateRange: 'readonly',
        filterUserReservations: 'readonly',
        findLastRowOfDateBlock: 'readonly',
        ...
        logSalesFromArchivedData: 'readonly',
