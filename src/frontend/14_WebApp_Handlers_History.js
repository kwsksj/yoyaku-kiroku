        ...
        if (response.success) {
          ...
          if (typeof details === 'object' && details !== null) {
            ...
            if (accounting.tuition && accounting.tuition.items) {
              ...
              formattedHtml += '<h4 class="font-medium text-brand-text mb-2">【授業料】</h4>';
            ...
            // 販売情報
            if (accounting.sales && accounting.sales.items && accounting.sales.items.length > 0) {
              formattedHtml += '<div class="mb-4">';
              formattedHtml += '<h4 class="font-medium text-brand-text mb-2">【販売】</h4>';
              formattedHtml += '<div class="text-sm space-y-1">';
            ...
            details = formattedHtml || '<div class="text-gray-500">会計記録の詳細情報がありません</div>';
