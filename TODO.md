...
| --- | ----------- | ------------------------------------------ | -------- | ---------- | ---- | ------ | ------ |
| 1   | UI          | 参加者/ログビューにデータ取得日時を表示    |          | 低         | 小   | 低     | ✅完了 |
| 2   | UI          | よやく詳細画面の販売品項目の見え方調整     |          | 低         | 小   | 低     | 未着手 |
| 3   | Performance | ログイン時に参加者ビューのデータも取得     |          | 低         | 中   | 低     | ✅完了 |
| 4   | Bug         | インクリメンタルキャッシュ更新の検証       |          | 中         | 小   | 低     | 未着手 |
| 5   | Bug         | 管理者ログイン時のビュー遷移タイミング改善 |          | 低         | 小   | 低     | ✅完了 |
...
| 15  | Performance | 参加者/ログビューのデータ同時取得          |          | 低         | 中   | 低     | ✅完了 |
