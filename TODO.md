...
| 8 | Feature | ユーザーページ遷移ログの可視化 | | 低 | 中 | 低 | | 9 | Feature | 画像アップロード機能 | | 低 | 大 | 中 | | 10 | Feature | `setDataFreshness` 機能の実装 | | 低 | 小 | 低 | | 11 | Performance | 終了フロー中の入力リアルタイム保存 | | 低 | 小 | 低 | | 12 | Refactor | 不要なconsole.log削除 | | 中 | 小 | 低 | | 13 | UI | iPhone表示の調整 | | 中 | 中 | 低 | | 14 | Feature | 終了フローで彫刻刀レンタルオプション表示 | | 中 | 中 | 低 |
