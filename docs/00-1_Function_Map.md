...
【ファイル名】: 00-1_Function_Map.md
【バージョン】: 1.1

## 【役割】

- このプロジェクトに存在する全ての主要な関数とその依存関係を定義する。
...
- **備考**: このマップは、関数間の「呼び出し関係」というマクロな視点での依存関係を把握することを目的としています。引数や戻り値といった詳細なインターフェース仕様については、各ソースコード内のJSDocコメントを参照してください。
